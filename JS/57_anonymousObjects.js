...
benefits; less syntax, no need for unique names
*/
...
// YOU CAN DO IT THE ANONYMOUS WAY WHICH IS THIS
let cards = [
  new Card("A", "Hearts"),
  new Card("A", "Spades"),
  new Card("A", "Diamonds"),
...
// TO ACCESS THEM IN THIS FORM
console.log(cards[5].value + cards[2].suit);

// TO ACCESS THEM WITH forEach WITH ARROW FUNCTION
cards.forEach((card) => {
...
// ACCESSING THE CARDS DIRECTLY BY NAME
console.log(card1.value + " " + card1.suit);

// ACCESSING THE CARDS INDIRECTLY BY AN ARRAY INDEX
